    ...
    <div class="alldiv clearl">
        ...
        <div id="signUpMsg">
            <ol style="list-style: none;">
                <li>
                    <h4>※회원가입시 <span style="color: red;font-size: 21px;">주의사항</span></h4>
                </li>
                <li>
                    <h4>회원가입시 <button onclick="document.getElementById('terms').style.display='block'"
                            style="width: auto;" type="button" class="linkBtn">이용약관</button>을 동의한 것으로 간주됩니다.<button
                            onclick="document.getElementById('terms').style.display='block'" style="width: auto;"
                            type="button" class="linkBtn">이용약관</button>을 확인하여 주시기 바랍니다.</h4>
                </li>
            </ol>
        </div>
